...
var Stave = (function () {
    function Stave(paper, x, y, width, height) {
        this.paper = paper;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    Stave.prototype.drawStave = function () {
        var scaledHeight = this.scale * this.heightBetweenLines;
        for (var i = 0; i < 5; ++i) {
    ...
    Stave.prototype.drawClef = function (height) {
    ...
    Stave.prototype.addToNoteStart = function (offset) {
        this.noteStart += offset;
    };
    Stave.prototype.getNoteStart = function () {
        return this.noteStart;
    };
    Stave.prototype.getHighlightShape = function (id) {
        return this.idShapeMapping[id];
    };
    Stave.prototype.drawScaledNoteAtPosition = function (glyphPath, xPos, yPos, scale) {
    ...
    Stave.prototype.drawNotes = function (notes) {
    ...
    Stave.prototype.drawExtraLines = function (xCoord, octave, notePlacement) {
    ...
    Stave.prototype.getDrawClef = function () {
        return this.shouldDrawClef;
    };
    Stave.prototype.setDrawClef = function (drawClef) {
        this.shouldDrawClef = drawClef;
    };
    Stave.prototype.setType = function (type) {
        this.selectedClef = type;
    };
    Stave.prototype.getType = function () {
